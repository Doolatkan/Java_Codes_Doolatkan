...
//		    	
//		    	 title = employee.substring(employee.indexOf("[")+1, employee.indexOf("]"));
//		    	 System.out.println(title);
//		    }
		    
		    //print all first name - last name jobtitle
		    
		    //1-way
//		    for(String employee : employees) {
//		    	
//		    	String firstLast = employee.substring(0, employee.indexOf("[")-1).replace(" ", "-")+ " " + employee.substring(employee.indexOf("[")+1, employee.indexOf("]"));
...
//		    }
		    ...
		    //2-way
//            for(String employee : employees) {
//		    	String[] all = employee.split(" ");
//		    	String first = all[0];
//		    	String last  = all[1];
//		    	System.out.println(first + "-" + last + " " + employee.substring(employee.indexOf("[")+1, employee.indexOf("]"))); 
//		    	
//		    }
            
            for(String bartle : employees) {
		    	String[] all =  bartle.split(" ");
		    	String first = all[0];
		    	String last  = all[1];
		    	String title1 = bartle.substring(bartle.indexOf("[")+1, bartle.indexOf("]"));
		    	String look = first + " " + last + " " + title1;
		    	
		    	if(look.equals("Tracy Bartle Geological Engineer")){
